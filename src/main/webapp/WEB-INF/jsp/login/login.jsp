...
<head>
	...
	<script>
		...
		<div style="text-align: center"> <font color="#9400D3"><font size=7 style="text-align: center">Autenticacao </font></font>
		</div>
		
		<div style="text-align: center"><i class="fa fa-exclamation-circle"></i>
					<br> <br> <br>	&nbsp; <strong> ${error} </strong>
		</div>
		...
		<div class="rain">
			<div class="border start">
				<form action="<c:url value='/autenticar' />" method="post">
					...
					<input name="usuario.login" type="text" placeholder="Email"/>
					<label for="pass">Password</label>
					<input name="usuario.senha" type="password" placeholder="Password"/>
                                        <input type="submit"/>
				</form>
			</div>
		</div>
